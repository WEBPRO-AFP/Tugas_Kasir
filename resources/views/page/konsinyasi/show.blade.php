<x-app-layout>
            ...
            <div class="gap-5 items-start flex">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-1/2 p-4">
                    <div class="p-4 bg-gray-100 mb-2 rounded-xl font-bold">
                        FORM INPUT KONSINYASI PRODUK
                    </div>
                    <div>
                        <form class="max-w-sm mx-auto" method="POST" action="{{ route('detailKonsinyasi.store') }}">
                            @csrf
                            <div class="mb-5">
                                ...
                                <input type="text" name="kode_konsinyasi"
                                    ...
                                    value="{{ $kode_konsinyasi->kode_konsinyasi }}" readonly />
                            </div>
                            <div class="mb-5">
                                <label for="kode_konsinyasi_detail"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Konsinyasi
                                    Produk</label>
                                <input type="text" name="kode_konsinyasi_detail"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required placeholder="Kode Konsinyasi" value="{{ $kodeKonsinyasiDetail }}"
                                    readonly />
                            </div>
                            <div class="mb-5">
                                <label for="produk"
    ...
    <script>
        const editSourceModal = (button) => {
            ...
            let url = "{{ route('detailKonsinyasi.update', ':id') }}".replace(':id', id);
            console.log(url);
