                            ...
                            <form class="w-full mx-auto" method="POST" action="{{ route('penjualan.store') }}">
                                ...
                                <div class="flex gap-5">
                                    <div class="mb-5 w-full">
                                        <label for="kode_penjualan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Penjualan</label>
                                        <input type="text" id="kode_penjualan" name="kode_penjualan" value="{{ $kodePenjualan }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Kode Penjualan" readonly required />
                                    </div>
                                    <div class="mb-5 w-full">
                                        <label for="tgl_penjualan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal Penjualan</label>
                                        <input type="date" id="tgl_penjualan" name="tgl_penjualan" value="{{ date('Y-m-d') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                                    </div>
                                </div>
                                <div class="flex gap-5">
                                    <div class="mb-5 w-full">
